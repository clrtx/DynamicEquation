...
class Form(QWidget):
    ...
    def test(self):
        xNameArray = ["среднегодовой % выпускников-бакалавров",
                      "среднегодовой % выпускников-магистров",
                      "текущий % выпускников-бакалавров, закончивших обучение в срок",
                      "текущий % выпускников-магистров, закончивших обучение в срок",
                      "текущий % выпускников-магистров, закончивших обучение",#Рандом
                      "общее количество публикаций",
                      "текущий % доходов из внешних источников",
                      "текущее количество исследований в области искусств",
                      "текущее количество часто цитируемых публикаций",
                      "текущий % совместных с регионом исследовательских публикаций",
                      "среднегодовой % постдоков",
                      "текущий % совместных с промышленными предприятиями",
                      "текущий % доходов от сторонних организаций",
                      "текущее количество присужденных патентов",
                      "текущий % совместных с частными организациями патентов",
                      "текущее количество малых инновационных предприятий на 1 штатного академического сотрудника",
                      "текущий % исследовательских публикаций по патентам",
                      "% доходов от непрерывного профессионального развития",
                      "текущее количество программ на иностранных языках для бакалавров",
                      "текущее количество исследований в области искусств",
                      "среднегодовой % иностранных студентов",
                      "среднегодовой % студентов, участвующих в программах обмена",
                      "среднегодовой % студентов, участвующих в международных программах",
                      "среднегодовой % иностранных сотрудников",
                      "текущий % совместных международных публикаций",
                      " среднегодовой % иностранных выпускников-докторантов",
                      "среднегодовой % выпускников-бакалавров, работающих в регионе",
                      "среднегодовой % выпускников-магистров, работающих в регионе",
                      "среднегодовой % студентов, участвующих в программах обмена",
                      "текущий % совместных с регионом исследовательских публикаций",
                      "текущий % доходов из региональных источников",
                      "test1",
                      "test2",
                      "test3"
                      ]
